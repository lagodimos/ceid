...
Για όσο η επιλογη δεν ειναι 0
    ...
    Αν είναι 3 βάλε τις λέξεις σε αλφαβητική σειρά
    Αν είναι 4 βάλε τις λέξεις σε αντίστροφη αλφαβητική σειρά
    Αν είναι 5 δώσε τα στατιστικά
    Αν είναι 6 δώσε τα στατιστικά για συγκεκριμένο χαρακτήρα που θα δώσει ο χρήστης
*/
...
int main() {
    ...
    "4. Sort words (in reversed alphabetical order)\n"
    "5. View statistics\n"
    "6. View statistics for specific character\n";
    ...
    do {
        ...
        switch (option) {
            ...
            case 2:
                ...
                break;
            case 3:
                sortInc4String(words, words_num, MAX_LENGTH);
                break;
            case 4:
                sortDec4String(words, words_num, MAX_LENGTH);
                break;
            case 5:
